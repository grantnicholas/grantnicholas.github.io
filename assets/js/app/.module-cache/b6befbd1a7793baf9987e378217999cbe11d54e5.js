require(["jquery", "underscore"], function($, _) {
    $(function() {
        ...
        var PostList = React.createClass({displayName: "PostList",
            ...
            render: function() {
                ...
                var posts = this.props.data.map(function(post) {
                    ...
                    return ( React.createElement(Post, {title: 
                            post.title, 
                ...
                return ( React.createElement("ul", {id: "search-items"}, " ", 
                    posts, 
                " "));
            }
        ...
        var SearchBox = React.createClass({displayName: "SearchBox",
            ...
            render: function() {
                return ( React.createElement("div", {id: "search-box"}, 
                    React.createElement(SearchBar, {update_searchbox: 
                        this.update_state, 
                    
                    query: 
                        this.state.query
                    }
                    ), " ", React.createElement(PostList, {data: 
        ...
        React.render( React.createElement(SearchBox, {data: 
                blog_data
            }
            ),
